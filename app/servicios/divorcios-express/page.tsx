...
import { Heart, ArrowRight, Sparkles, Clock, FileCheck, Shield } from "lucide-react"
...
const specificServices = [
  { title: "Divorcio por mutuo acuerdo", desc: "Proceso ágil cuando ambas partes están de acuerdo en disolver el vínculo" },
  { title: "Convenio regulador", desc: "Redacción y acuerdo sobre división de bienes, custodia y alimentos" },
  { title: "División de bienes", desc: "Liquidación y partición de la sociedad conyugal" },
  { title: "Acuerdos de custodia", desc: "Régimen de cuidado personal de los hijos y comunicación" },
  { title: "Mediación familiar", desc: "Resolución de conflictos familiares sin litigio judicial" },
]

const whyUs = [
  { icon: Sparkles, text: "Proceso rápido y eficiente (2-3 meses promedio)" },
  { icon: Heart, text: "Atención sensible y profesional en momentos difíciles" },
  { icon: FileCheck, text: "Costos transparentes y presupuesto claro" },
  { icon: Shield, text: "Enfoque en soluciones amistosas" },
]
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-32 sm:py-40 lg:px-8">
          <nav className="flex mb-8 text-sm text-gray-500" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2">
              ...
              <li>/</li>
              <li className="text-gray-900 font-medium">Divorcios Exprés</li>
            </ol>
          </nav>
          ...
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <FadeIn delay={0.2}>
              <p className="mt-6 text-xl leading-8 text-gray-600">
                Facilitamos procesos de divorcio ágiles y eficientes en Jesús María, Colonia Caroya y toda Córdoba,
                minimizando el impacto emocional y económico para todas las partes.
              </p>
            </FadeIn>
          </div>
          ...
          <FadeIn delay={0.5}>
            <div className="mt-16 p-8 rounded-2xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20">
              <div className="text-center">
                <h2 className="text-2xl font-serif text-gray-900">¿Considerando un Divorcio?</h2>
                <p className="mt-4 text-lg text-gray-600">
                  Hacemos el proceso más sencillo y rápido. Consulte sin compromiso sobre su situación.
                </p>
